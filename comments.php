...
// var_dump($parameter); 
    $this->widget('sapphire_Widget_Comments_Archive', $parameter)->to($comments);
  //var_dump($comments); 

        ?>
		<?php //if (($this->options->is_comment===1&&$this->allow('comment')&&stripos($_SERVER['HTTP_ACCEPT_LANGUAGE'], 'zh') > -1)||$this->options->is_comment===0&&$this->allow('comment')): ?>
        <?php  if ($this->allow('comment') && stripos($_SERVER['HTTP_ACCEPT_LANGUAGE'], 'zh') > -1): ?><?php //$this->header('commentReply=1&description=0&keywords=0&generator=0&template=0&pingback=0&xmlrpc=0&wlw=0&rss2=0&rss1=0&antiSpam=0&atom'); ?>
        <div id="<?php $this->respondId(); ?>" class="respond">
            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form">
                ...
                <p style="margin-top:0">
                    ...
                    <textarea class="input-area" cols="94" rows="8" name="text" id="textarea" placeholder="在这里输入你的评论..." style="resize:none;"><?php $this->remember('text'); ?></textarea>
                </p>
